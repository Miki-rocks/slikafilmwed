...
$array_defaults = array(
	...
	'link' => '',
	'image_id' => '',
	'color' => 'color-white', // all the classes for title
	'classes' => '',
);
...
<div class="<?php echo $baseClass . ' ' . $args['classes']; ?> h-100 position-relative pb-7">
	<div>
		<div class="<?php echo $baseClass; ?>__image position-image__wrap position-relative overflow-hidden">
			<?php echo wp_get_attachment_image($args['image_id'], 'news-card', '', ['class' => 'position-image__wrap__image', 'title' => $args['title']]); ?>
		</div>
	</div>
